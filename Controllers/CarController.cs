...
namespace RentCar.Controllers
{
    ...
    public class CarController : Controller
    {
        ...
        [HttpDelete("{phoneNumber}/delete/{carId}")]
        public async Task<ActionResult> DeleteCar(string phoneNumber, int carId)
        {
            var user = await _context.Users.Include(u => u.Car)
            ...
            if (car.CreatedBy != user.PhoneNumber)
            {
                return NotFound("You are not allowed to delete this car.");
            }
